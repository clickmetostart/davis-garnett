...
export default function OnboardingSetup() {
  ...
  const steps = [
    ...
    { 
      id: 'communicationsWalkthrough', 
      title: 'Communications', 
      description: 'Manage your unified inbox across all channels.', 
      isCompleted: onboardingData.communicationsWalkthrough, 
      actionLabel: 'Start Walkthrough',
    ...
    { 
      id: 'assetsWalkthrough', 
      title: 'Brand Assets', 
      description: 'Upload your logos, brand colors, and fonts.', 
      isCompleted: onboardingData.assetsWalkthrough, 
      actionLabel: 'Start Walkthrough',
      route: '/clickme/assets',
    ...
    { 
      id: 'schedulerWalkthrough', 
      title: 'Social Planner', 
      description: 'Schedule and manage your multi-channel posts.', 
      isCompleted: onboardingData.schedulerWalkthrough, 
      actionLabel: 'Start Walkthrough',
      route: '/clickme/scheduler',
    ...
    { 
      id: 'listingsWalkthrough', 
      title: 'Property Listings', 
      description: 'Manage and syndicate your active properties.', 
      isCompleted: onboardingData.listingsWalkthrough, 
      actionLabel: 'Start Walkthrough',
      route: '/clickme/listings',
    ...
    { 
      id: 'marketingWalkthrough', 
      title: 'Marketing Engine', 
      description: 'Create dripping campaigns and email templates.', 
      isCompleted: onboardingData.marketingWalkthrough, 
      actionLabel: 'Start Walkthrough',
      route: '/clickme/marketing',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
    },
    { 
    ...
    { 
      id: 'flowWalkthrough', 
      title: 'Agent Flow', 
      description: 'Organize your tasks and pipelines visually.', 
      isCompleted: onboardingData.flowWalkthrough, 
      actionLabel: 'Start Walkthrough',
      route: '/clickme/flow',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="3" x2="9" y2="21"></line><line x1="15" y1="3" x2="15" y2="21"></line></svg>
    },
    { 
      id: 'reputationWalkthrough', 
      title: 'Reputation Engine', 
      description: 'Monitor your Google and Yelp reviews automatically.', 
      isCompleted: onboardingData.reputationWalkthrough, 
      actionLabel: 'Start Walkthrough',
      route: '/clickme/reputation',
