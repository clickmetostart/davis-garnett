        ...
        <div className="max-w-7xl mx-auto border-t border-[#ef5728]/40 pt-8 px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-[#888] text-[11px] leading-snug items-end">
          ...
          <div className="flex flex-col gap-4 text-center md:text-left">
            <div>
              ...
              <p>
                © {new Date().getFullYear()} Davis & Garnett. All Rights Reserved. An independent team affiliated with Align Right Realty Carrollwood. Equal Housing Opportunity. REALTOR® is a registered trademark of the National Association of REALTORS®.
              </p>
            </div>
          </div>
